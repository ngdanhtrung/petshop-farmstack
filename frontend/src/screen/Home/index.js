...
const Home = () => {
  return (
    <>
      <img src={ima} alt='img' className='img-home' />
      ...
      <section className='sec1'>
        <div className='title'>
          ...
          <div className='view-service'>
            <img src={dichvu} alt='dich-vu' className='dich-vu' />
            <nav>
              <Link to='/Service' exact className='link-service'>
                Xem các dịch vụ của Pets Shop
              </Link>{" "}
            </nav>
            <Switch>
